...
from ekankth import aiohttpsession as aiosession
from ekankth.utils.http import get, post
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("ekankth/resources/default.ttf", 55)
    file = f"tg_bot/resources/{randint(1000, 9999)}.jpg"
