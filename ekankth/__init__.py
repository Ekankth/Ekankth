...
def get_user_list(key):
    ...
    from ekankth.modules.sql import nation_sql
    royals = nation_sql.get_royals(key)
    return [a.user_id for a in royals]

FORMAT = "[ekankth] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[ekankth]')
LOGGER.info("Ekankth is starting. | Ekankth Projects. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime.")
LOGGER.info("Project maintained by: github.com/Ekankth (t.me/ekankth)")
...
#print(flag)
log = logging.getLogger('[ekankth]')
logging.getLogger('ptbcontrib.postgres_persistence.postgrespersistence').setLevel(logging.WARNING)
logging.getLogger("pyrogram").setLevel(logging.INFO)
log.info("[Ekankth] Takehito is starting. | Rendy Project. | Licensed under GPLv3.")
log.info("[Ekankth] Not affiliated to other anime.")
log.info("[Ekankth] Project maintained by: github.com/Randi356 (t.me/rencprx)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[Ekankth] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)
...
KInit = EkankthINIT(parser=renconfig)
...
try:
    REDIS.ping()
    LOGGER.info("[Ekankth] Your redis server is now alive!")
